...
state.sequence         <- list(1:7, 1:7)[[scenario]]
transition.sequence    <- list(1:9, 1:9)[[scenario]]                                  
...
computer    <- 2
output.path <- c("C:/Users/mpetty/Desktop/Working, CS 330/", "Z:/UAH/CS330/Programming Assignments/Programming Assignment 4/")[computer]
